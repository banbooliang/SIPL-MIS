...
class UNETR_PP(SegmentationNetwork):
    ...
    def forward(self, x_in):
        ...
        #print(enc1.shape, enc2.shape, enc3.shape, enc4.shape, self.hidden_size, self.feat_size)
        ...
        #print(dec4.shape, dec3.shape, dec2.shape, dec1.shape)
