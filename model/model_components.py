...
from model.dynunet_block import get_conv_layer, UnetResBlock


einops, _ = optional_import("einops")

class UnetrPPEncoder(nn.Module):
    def __init__(self, input_size=[96 * 24 * 24, 48 * 12 * 12, 24 * 6 * 6, 12 * 3 * 3],dims=[32, 64, 128, 256],
...
class UnetrUpBlock(nn.Module):
    ...
    def forward(self, inp, skip):
        ...
        out = out + skip
       # print('---decoder inp shape:{}'.format(out.shape))
